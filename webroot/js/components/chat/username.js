    ...
    return html`
      <div id="user-info" class="whitespace-nowrap">
        <div
          ...
          class="flex flex-row justify-end items-center cursor-pointer py-2 px-4 overflow-hidden w-full opacity-1 transition-opacity duration-200 hover:opacity-75"
          onClick=${this.handleDisplayForm}
        >
          <span
            id="username-display"
            class="text-indigo-600 text-xs font-semibold truncate overflow-hidden whitespace-no-wrap"
            >${username}</span
          >
        </div>
